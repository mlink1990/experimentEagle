...
omegaMeasured = 6.176*kHz
PdBForMeasured = 10.0 # note we had a 10dB attentuator in place for this measurement # 2016-08-16
deltaForAlpha = 60.4*kHz # this sets your alpha
omegaForAlpha = 1# dB # this sets your alpha
f0 = 81.31#MHz measured resonance frequency
...
if __name__=="__main__":
    varsDict = {"PIDFeshbachSetVoltage":1.6336, "BeamPowerSetVoltageDipoleHorizontalRecompressed":0.75,"PiPulseRFPowerdBm":12,"PiPulseRFFreqMHz":81.31528 }
