...
#    rabiFreqEffectiveGapUnitsSigned = detuningSign*rabiFreqEffectiveGapUnits
    names = ["fieldValueGaussPiPulse","EFermi","kFermi","a12","a13","a23","kFa_12","kFa_13","kFa_23","BCSGap_12","BCSGap_13","BCSGap_23"]
    values = [fieldValueGauss,EFermi,kFermi,a12,a13,a23,kFa_12,kFa_13,kFa_23,BCSGap_12,BCSGap_13,BCSGap_23]
    roundingDigits = 4
